...
gulp.task('build-bower-js', function(){
	return gulp.src([config.bower_lib+config.angular_js_file,config.bower_lib+config.jquery_js_file])
		.pipe(outputBower());
});
...
gulp.task('watch', function(){
	...
	gulp.watch([config.bower_lib+config.angular_js_file,config.bower_lib+config.jquery_js_file], ['build-bower-js']);
